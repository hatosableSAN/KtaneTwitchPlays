	...
	private void ConnectToIRC()
	{
		...
		try
		{
			...
			try
			{
				...
				NetworkStreamLineReader inputStream = new NetworkStreamLineReader(networkStream, protocol.Stream);
				StreamWriter outputStream = new StreamWriter(protocol.Stream);
